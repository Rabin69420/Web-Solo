    ...
    <div className="font-sans">
      ...
      <nav className="flex items-center justify-between px-6 py-4 border-b">
        ...
        <div className="flex space-x-4">
          <Link to="/">
            <button className="text-sm font-medium px-4 py-2 rounded hover:bg-blue-100">
              Home
            </button>
          </Link>
          <Link to="/browse">
      ...
      <section className="px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="rounded shadow hover:shadow-lg transition p-4">
            ...
            <p className="text-blue-600 font-medium mt-2">Rs. 35,000/month</p>
          </div>
          ...
          <div className="rounded shadow hover:shadow-lg transition p-4">
            ...
            <p className="text-gray-600">Mahadevsthan, Koteshwor</p>
            <p className="text-blue-600 font-medium mt-2">Rs. 31,000/month</p>
          </div>
          ...
          <div className="rounded shadow hover:shadow-lg transition p-4">
            ...
            <p className="text-blue-600 font-medium mt-2">Rs. 30,000/month</p>
          </div>
        </div>
      </section>
    </div>
